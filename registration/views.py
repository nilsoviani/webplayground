...
# from django.views.generic.base import TemplateView se cambia por un UpdateView
...
class ProfileUpdate(UpdateView):
    # model = Profile reemplazado por form_class para tomar las clases y estilos personalizados
    ...
    def get_object(self):
        # Para recuperar el objeto que se va a editar
        profile, created = Profile.objects.get_or_create(user=self.request.user)
        return profile

    def get_success_url(self):
        return reverse_lazy('profile') + '?updated'
